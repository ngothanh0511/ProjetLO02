...
public class JoueurVirtuel extends Joueur {
	...
	public void getCibleAttaque() {
		...
		System.out.println("Le Joueur "+id+" choisit d'appliquer la capacit� sp�ciale de sa carte sur joueur "+cibleAttaque.get(0).id);
	}
		}
	}
	/**
	...
	public void activerCapaciteSpeciale(Carte carte, StockCarte s) {
		...
		case ("F_1"):
			if (carte.getOrigine() == "Jour") {
				...
				ptActionNeant += 1;
				System.out.println("Le Joueur_"+id+" a re�u 1 point d'Action Néant");
			}
			break;
