...
public class StockCarte {
	...
	public StockCarte(){
		...
		GuideSpirituel c_52 = new GuideSpirituel("Asc̬te", 52, "GuideSpirituel", "Nuit",new String[] {"Hunmain", "Symboles"}, 1, "F_16"); 
...
//		DeusEx c_69= new DeusEx("Influence N̩ant", 69, "DeusEx", "None", "F_26");
	...
	public  void  distribuerCartes(Main laMain){
		...
		for (int i=1; i< (8- laMain.getNbrCartes()); i++ ){
			try{
				...
				getStockCarte();
				//System.out.println("Le jeu est preque fini");
				break;
			}
		}
